...
sampler2D sRoughness : register(s2);
sampler2D sEmissiveMap : register(s3);
sampler2D sMetalness : register(s3);
...
Texture2D tRoughness : register(t2);
Texture2D tEmissiveMap : register(t3);
Texture2D tMetalness : register(t3);
...
SamplerState sRoughness : register(s2);
SamplerState sEmissiveMap : register(s3);
SamplerState sMetalness : register(s3);
